...
bem: main.o topology.o linearsolver.o nonlinearsolver.o matrixsetup.o warmstart.o
	$(CC) -o bem main.o topology.o linearsolver.o nonlinearsolver.o matrixsetup.o warmstart.o $(CFLAGS) $(LIBS)
