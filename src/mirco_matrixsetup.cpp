    ...
    int systemsize, bool PressureGreenFunFlag)
{
  ...
  {
    // The pressure-based Green's function is based on the work of Pohrt and Li (2014) https://doi.org/10.1134/S1029959914040109
    ...
    // The paper uses a decoupled shear modulus and Poisson's ratio. We use a composite Young's modulus here, instead. 
